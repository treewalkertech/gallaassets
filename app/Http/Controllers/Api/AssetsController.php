...
class AssetsController extends Controller
{
...

    {
        ...
        /* check the multiple assets audit */
	$isMultipleTagEnbled = ($request->has("multiple")) ? $request->input("multiple") : false;

        if(!$isMultipleTagEnbled){
	    ...
	    /*$validator = Validator::make($request->all(), [
        	'barcodes' => 'required|array', // Must be present and an array
        	'barcodes.*.code' => 'required|string', // Each item must have a 'code' string
	    ]);*/
