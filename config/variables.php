...
// Variables
return [
  "creatorName" => "Treewalker",
  "creatorUrl" => "https://themeselection.com",
  "templateName" => "Treewalker",
  "organizationName" => "Treewalker Technologies",
  "templateSuffix" => "Technologies",
  "templateVersion" => "1.1.0",
  "templateFree" => true,
  "templateDescription" => "Treewalker Technologies",
  "templateKeyword" => "Treewalker Technologies",
