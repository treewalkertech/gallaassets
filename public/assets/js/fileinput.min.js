...
(function (factory) {
  ...
  $h = {
    ...
    isEmpty: function (value, trim) {
      return (
        value === undefined ||
        value === null ||
        (!$h.isFunction(value) && (value.length === 0 || (trim && $.trim(value) === '')))
      );
    },
    isArray: function (a) {
  ...
  FileInput.prototype = {
    ...
    _initTemplateDefaults: function () {
      ...
      tFileIcon = '<i class="bx bx-file-blank"></i>';
      ...
      tModal =
        ...
        '      <div class="kv-zoom-actions">{toggleheader}{fullscreen}{borderless}\n' +
        '<button type="button" class="btn btn-label-danger p-1" data-bs-dismiss="modal" aria-label="Close"><i class="bx bx-x"></i></button></div>\n' +
        '    </div>\n' +
      ...
      /* customized to add the alt */
      tFooter = '<div class="file-thumbnail-footer">\n' + '    <div class="file-footer-caption" title="{caption}">\n';
      //  '        <div class="file-caption-info">{caption}</div>\n' +
      tFooter += '        <div class="file-size-info">{size}</div>\n';
      if (self.imgAlt) {
        tFooter +=
          '        <input class="form-control" type="text" name="imgalt[]" value="{caption}" placeholder="Alt Text"/>\n';
      }
      tFooter += '    </div>\n' + '    {progress}\n{indicator}\n{actions}\n' + '</div>';
      tActions =
      ...
      self.defaults = {
        ...
        fileActionSettings: {
          ...
          uploadIcon: '<i class="bx bx-upload" ></i>',
          uploadClass: 'btn btn-sm btn-kv btn-default btn-outline-secondary',
          uploadTitle: 'Upload file',
          uploadRetryIcon: '<i class="bx bx-repeat"></i>',
          uploadRetryTitle: 'Retry upload',
          downloadIcon: '<i class="bx bx-download"></i>',
          downloadClass: 'btn btn-sm btn-kv btn-default btn-outline-secondary',
          downloadTitle: 'Download file',
          zoomIcon: '<i class="bx bx-zoom-in"></i>',
          zoomClass: 'btn btn-sm btn-kv btn-default btn-outline-secondary',
          zoomTitle: 'View Details',
          dragIcon: '<i class="bx bx-move"></i>',
          dragClass: 'text-info',
          dragTitle: 'Move / Rearrange',
          dragSettings: {},
          indicatorNew: '<i class="bx bxs-plus-circle text-warning"></i>',
          indicatorSuccess: '<i class="bx bxs-check-circle text-success"></i>',
          indicatorError: '<i class="glyphicon glyphicon-exclamation-sign text-danger"></i>',
          indicatorLoading: '<i class="bx bx-hourglass text-muted"></i>',
          indicatorPaused: '<i class="bx bx-pause text-primary"></i>',
    ...
    _parseError: function (operation, jqXHR, errorThrown, fileName) {
      ...
      var self = this,
        ...
        textPre,
        text =
          jqXHR.responseJSON !== undefined && jqXHR.responseJSON.error !== undefined
  ...
  $.fn.fileinput.defaults = {
    ...
    previewZoomButtonIcons: {
      prev: '<i class="bx bxs-left-arrow"></i>',
      next: '<i class="bx bxs-right-arrow"></i>',
      toggleheader: '<i class="bx bx-move-vertical"></i>',
    ...
    customLayoutTags: {},
    customPreviewTags: {},
    previewFileIcon: '<i class="bx bxs-file-blank"></i>',
    previewFileIconClass: 'file-other-icon',
    previewFileIconSettings: {},
    previewFileExtSettings: {},
    buttonLabelClass: 'hidden-xs',
    browseIcon: '<i class="bx bxs-folder-open"></i>&nbsp;',
    browseClass: 'btn btn-primary',
    removeIcon: '<i class="bx bxs-trash" ></i>',
    removeClass: 'btn btn-default btn-secondary',
    cancelIcon: '<i class="bx bxs-minus-circle" ></i>',
    cancelClass: 'btn btn-default btn-secondary',
    pauseIcon: '<i class="bx bx-pause" ></i>',
    ...
    msgValidationErrorIcon: '<i class="bx bxs-error-circle"></i>',
