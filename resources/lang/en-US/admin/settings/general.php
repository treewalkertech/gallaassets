...
'ldap_location_help'             => 'The Ldap Location field should be used if <strong>an OU is not being used in the Base Bind DN.</strong> Leave this blank if an OU search is being used.',
    ...
    'ldap_activated_flag_help'  => 'This value is used to determine whether a synced user can login to Treewalker. <strong>It does not affect the ability to check items in or out to them</strong>, and should be the <strong>attribute name</strong> within your AD/LDAP, <strong>not the value</strong>. <br><br>If this field is set to a field name that does not exist in your AD/LDAP, or the value in the AD/LDAP field is set to <code>0</code> or <code>false</code>, <strong>user login will be disabled</strong>. If the value in the AD/LDAP field is set to <code>1</code> or <code>true</code> or <em>any other text</em> means the user can log in. When the field is blank in your AD, we respect the <code>userAccountControl</code> attribute, which usually allows non-suspended users to log in.',
    ...
    'load_remote_help_text'		=> 'Uncheck this box if your install cannot load scripts from the outside internet. This will prevent Treewalker from trying load avatars from Gravatar or other outside sources.',
    ...
    'login_remote_user_custom_logout_url_help' => 'If a url is provided here, users will get redirected to this URL after the user logs out of Treewalker. This is useful to close the user sessions of your Authentication provider correctly.',
    ...
    'show_images_in_email_help'   => 'Uncheck this box if your Treewalker installation is behind a VPN or closed network and users outside the network will not be able to load images served from this installation in their emails.',
    'site_name'                 => 'Site Name',
    'integrations'              => 'Integrations',
    'service_desk'              => 'Service Desk',
    'service_desk_help'         => 'Configure service desk settings',
    'barcode_desk_help'         => 'Customize barcode format and display options',
    'slack'                     => 'Slack',
    ...
    'snipe_version'  			=> 'Treewalker version',
    'support_footer'            => 'Support Footer Links ',
    'support_footer_help'       => 'Specify who sees the links to the Treewalker Support info and Users Manual',
    'version_footer'            => 'Version in Footer ',
    'version_footer_help'       => 'Specify who sees the Treewalker version and build number.',
    ...
    'width_w'        => 'w',
    'height_h'        => 'h',
    'show_url_in_emails'                => 'Link to Treewalker in Emails',
    'show_url_in_emails_help_text'      => 'Uncheck this box if you do not wish to link back to your Treewalker installation in your email footers. Useful if most of your users never login. ',
    'text_pt'        => 'pt',
    ...
    'barcodes_help' => 'This will attempt to delete cached barcodes. This would typically only be used if your barcode settings have changed, or if your Treewalker URL has changed. Barcodes will be re-generated when accessed next.',
