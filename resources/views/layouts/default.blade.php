                                ...
                                @if (!empty($isServiceDeskSyncEnabled) && $isServiceDeskSyncEnabled)
                                    <li>
                                        <a href="#" id="syncAssets" class="dropdown-link" title="Sync Asset">
                                            ...
                                            <span
                                                id="syncText">{{ trans('general.syncasset') ?? 'Sync Asset' }}</span>
                                    ...
                                    <li>
                                        <a href="#" id="pushAllBarcodes" class="dropdown-link"
                                            title="Push Barcodes to SDP">
                                            <x-icon type="import" class="fa-fw" />
                                            <span
                                                id="barcodeAllText">{{ trans('general.pushbarcode') ?? 'Push Barcodes to SD' }}</span>
                            ...
                            <li{!! Request::query('status') == 'Pending' ? ' class="active"' : '' !!}><a href="{{ url('hardware?status=Pending') }}">
                                ...
                                <li{!! Request::query('status') == 'Undeployable' ? ' class="active"' : '' !!}><a href="{{ url('hardware?status=Undeployable') }}">
                                    ...
                                    <li{!! Request::query('status') == 'Archived' ? ' class="active"' : '' !!}><a href="{{ url('hardware?status=Archived') }}">
                                        ...
                                        <li{!! Request::query('status') == 'Requestable' ? ' class="active"' : '' !!}><a href="{{ url('hardware?status=Requestable') }}">
