...
Route::withoutMiddleware(['auth:api'])->group(function () {
    ...
    Route::post(
        '/assets/record-rfid-event',
        [AssetRfidController::class, 'recordFixedReaderRfidEvent']
    );
