<form method="POST" action="<?php echo e(route('inventory.bulkBondingPlanUpload')); ?>" enctype="multipart/form-data"
    id="bondingImport">
    <?php echo csrf_field(); ?>
...
<script>
    $(document).ready(function() {
        ...
        $("#import-format").click(function() {
            window.location.href = "<?php echo e(route('inventory.bondingPlanImportFormat')); ?>";
        });
    });
</script>
<?php /**PATH /var/www/html/laundryApp/resources/views/content/inventory/modal/bulkBondingProductImport.blade.php ENDPATH**/ ?>