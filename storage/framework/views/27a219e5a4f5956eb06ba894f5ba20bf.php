<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const QC_DATES = <?php echo json_encode($metrics['qc_dates'] ?? []); ?>;
        const QC_STAGE_SERIES = <?php echo json_encode($metrics['qc_stage_series'] ?? []); ?>;
        ...
        const DASHBOARD_METRICS_URL = "<?php echo e(url('dashboard/metrics')); ?>";
        setInterval(() => {
...
<?php /**PATH /var/www/html/gallamattressapp/resources/views/content/dashboard/script.blade.php ENDPATH**/ ?>