                        ...
                        <div class="row gy-4 gy-sm-1">
                            ...
                            <div class="col-sm-6 col-lg-3">
                                <div
                                    ...
                                    <div>
                                        <h3 class="mb-1">
                                            <?php echo e($productsOverview['total_mapped_products'] ?? '0'); ?>
                            ...
                            <div class="col-sm-6 col-lg-3">
                                <div
                                    ...
                                    <div>
                                        <h3 class="mb-1">
                                            <?php echo e($productsOverview['total_unmapped_products'] ?? '0'); ?>
                            ...
                            <div class="col-sm-6 col-lg-3">
                                <div
                                    ...
                                    <div>
                                        <h3 class="mb-1">
                                            <?php echo e($productsOverview['total_tags'] ?? '0'); ?>
...
<?php echo $__env->make('layouts/contentNavbarLayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/laundryApp/resources/views/content/products/list.blade.php ENDPATH**/ ?>