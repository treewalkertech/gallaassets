            ...
            <div class="row mb-3">
                ...
                <div class="col-md-10">
                    <input class="form-control" type="text" placeholder="Enter Company Name" name="company_name"
                        id="company_name" value="<?php echo e($UtilityHelper->getConfigValue("company_name")); ?>" required />
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-10">
                    <input class="form-control" type="text" placeholder="Enter Pan Number" name="company_pan_number"
                        id="company_pan_number" value="<?php echo e($UtilityHelper->getConfigValue("company_pan_number")); ?>" />
                    <div class="invalid-feedback"> This field is required. </div>
                </div>
            </div>
            <div class="row mb-3">
                ...
                <div class="col-md-10">
                    <input class="form-control" type="text" placeholder="Enter GST Number" name="company_gst_number"
                        id="company_gst_number" value="<?php echo e($UtilityHelper->getConfigValue("company_gst_number")); ?>" />
                    <div class="invalid-feedback"> This field is required. </div>
                </div>
            </div>
            <div class="row mb-3">
                ...
                <div class="col-md-10">
                    <input class="form-control" type="email" placeholder="Enter Email" name="company_email"
                        id="company_email" value="<?php echo e($UtilityHelper->getConfigValue("company_email")); ?>" />
                    <div class="invalid-feedback"> This field is required. </div>
                </div>
            </div>
            <div class="row mb-3">
                ...
                <div class="col-md-10">
                    <input class="form-control" type="tel" placeholder="Enter Phone" name="company_phone"
                        id="company_phone" value="<?php echo e($UtilityHelper->getConfigValue("company_phone")); ?>" />
                    <div class="invalid-feedback"> This field is required. </div>
                </div>
            </div>
            <div class="row mb-3">
                ...
                <div class="col-md-10">
                    <textarea class="form-control" id="company_address" rows="3" placeholder="Enter Full address"
                        name="company_address"><?php echo e($UtilityHelper->getConfigValue("company_address")); ?></textarea>
                    <div class="invalid-feedback"> This field is required. </div>
                </div>
            </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-10">
                    <input class="form-control" type="text" placeholder="Enter City" name="company_city"
                        id="company_city" value="<?php echo e($UtilityHelper->getConfigValue("company_city")); ?>" />
                    <div class="invalid-feedback"> This field is required. </div>
                </div>
            </div>
            <div class="row mb-3">
                ...
                <div class="col-md-10">
                    <input class="form-control" type="text" placeholder="Enter Pincode" name="company_pincode"
                        id="company_pincode" value="<?php echo e($UtilityHelper->getConfigValue("company_pincode")); ?>" />
                    <div class="invalid-feedback"> This field is required. </div>
                </div>
            </div>
            <div class="row mb-3">
                ...
                <div class="col-md-10">
                    <input class="form-control" type="text" placeholder="Enter State" name="company_state"
                        id="company_state" value="<?php echo e($UtilityHelper->getConfigValue("company_state")); ?>" />
                    <div class="invalid-feedback"> This field is required. </div>
                </div>
            </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-10">
                    <input class="form-control" type="text" placeholder="Enter Brand Name"
                        ...
                        value="<?php echo e($UtilityHelper->getConfigValue("company_brand_name")); ?>" />
                    <div class="invalid-feedback"> This field is required. </div>
                </div>
            </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-6 col-12">
                    <div class="d-flex justify-content-start align-items-center">
                        <?php if($UtilityHelper->getConfigValue("company_logo")): ?>
                            <div class="ms-2">
                                    ...
                                    <div class="card">
                                        <div class="card-body p-2">
                                            <img class="card-img-top p-1"
                                                src="<?php echo e(asset($UtilityHelper->getConfigValue("company_logo"))); ?>"
                        ...
                        <?php if($UtilityHelper->getConfigValue("company_brand_logo")): ?>
                            <div class="ms-2">
                                ...
                                <div class="d-flex align-items-start align-items-sm-center">
                                    <div class="card">
                                        <div class="card-body p-2">
                                            <img class="card-img-top p-1"
                                                src="<?php echo e(asset($UtilityHelper->getConfigValue("company_brand_logo"))); ?>"
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-10">
                    <textarea class="form-control" id="company_terms_and_conditions" rows="3"
                        placeholder="Enter Terms & Conditions" name="company_terms_and_conditions"><?php echo e($UtilityHelper->getConfigValue("company_terms_and_conditions")); ?></textarea>
                    <div class="invalid-feedback"> This field is required. </div>
                </div>
            </div>
            <div class="row mb-3">
...
<?php /**PATH /var/www/html/gallamattressapp/resources/views/content/settings/tabs/company_profile.blade.php ENDPATH**/ ?>