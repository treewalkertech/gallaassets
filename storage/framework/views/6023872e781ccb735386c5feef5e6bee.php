<form method="POST" action="<?php echo e(route('bonding.bulkBondingPlanUpload')); ?>" enctype="multipart/form-data" id="bondingImport">
    <?php echo csrf_field(); ?>
        ...
        <div class="modal-dialog modal-dialog-centered modal-md">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        <?php if(isset($locations_info) && $locations_info): ?>
...
<script>
    $(document).ready(function() {
        ...
        $("#import-format").click(function() {
            window.location.href = "<?php echo e(route('bonding.bondingPlanImportFormat')); ?>";
        });
    });
</script>
<?php /**PATH /var/www/html/gallamattressapp/resources/views/content/bonding/modal/bulkBondingProductImport.blade.php ENDPATH**/ ?>