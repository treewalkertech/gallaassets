<?php $__env->startSection('title', 'Users - Form'); ?>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header border-bottom">
                    <h5 class="card-title"><?php echo e(isset($user_id) ? 'Update User Information' : 'Add New User'); ?></h5>
                </div>
                <div class="card-body">
                        ...
                        <div class="row px-3 py-3" id="users_form">
                            ...
                            <div class="col-md-6 col-12 mb-3">
                                ...
                                <input type="text" id="fullName" name="fullName" class="form-control"
                                    placeholder="Full name" value="<?php echo e($info->fullname ?? ''); ?>" required />
                                    ...
                                    <select id="user_location_id" name="user_location_id" class="form-select" required>
                                        ...
                                        <?php $__currentLoopData = $locations_info ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $location): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($location->location_id); ?>"
                                                <?php echo e(isset($info->location_id) && $info->location_id == $location->location_id ? 'selected' : ''); ?>>
                            ...
                            <div class="col-md-6 col-12 mb-3">
                                ...
                                <select id="user_role_id" name="user_role_id" class="form-select" required>
                                    ...
                                    <?php $__currentLoopData = $roles_info ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $roles): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($roles->role_id); ?>"
                                            <?php echo e(isset($info->role_id) && $info->role_id == $roles->role_id ? 'selected' : ''); ?>>
                                            <?php echo e($roles->role_name); ?>
                            ...
                            <div class="col-md-6 col-12 mb-3">
                                ...
                                <input type="email" id="userEmail" name="userEmail" class="form-control"
                                    placeholder="treewalker@example.com" value="<?php echo e($info->email ?? ''); ?>" />
                            ...
                            <div class="col-md-6 col-12 mb-3">
                                ...
                                <input type="text" id="userContact" name="userContact" class="form-control phone-mask"
                                    placeholder="+1 (609) 988-44-11" value="<?php echo e($info->contact ?? ''); ?>" />
                            ...
                            <div class="col-md-6 col-12 mb-3">
                                ...
                                <input type="text" id="userName" name="userName" class="form-control"
                                    placeholder="Username" value="<?php echo e($info->username ?? ''); ?>" required />
                            ...
                            <div class="col-md-6 col-12 mb-3">
                                ...
                                <div class="form-check form-switch ms-3">
                                    <input type="checkbox" id="status" name="status" class="form-check-input fs-4"
                                        value="1"
                                        <?php echo e(isset($info->status) && strtolower($info->status) === 'active' ? 'checked' : 'checked'); ?>>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-12 mb-3">
                                ...
                                <select id="working_stage" name="working_stage[]" class="form-select" multiple>
                                    <?php $__currentLoopData = $stages ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $stage_name): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($value); ?>"
                                            <?php echo e(in_array($value, $working_stage) ? 'selected' : ''); ?>>
...
<?php $__env->startSection('page-script'); ?>
        ...
        $(document).ready(function() {
            ...
            Array.prototype.slice.call(forms).forEach(function(form) {
                form.addEventListener("submit", function(event) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "<?php echo e(route('users.save')); ?>" + '/' + user_id,
                        data: $(form).serialize(),
    ...
    <?php echo $__env->make('content.users.script', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts/contentNavbarLayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/gallamattressapp/resources/views/content/users/create.blade.php ENDPATH**/ ?>