                        ...
                        <div class="app-brand justify-content-center">
                            <a href="<?php echo e(url('/')); ?>" class="app-brand-link gap-2">
                                <span class="app-brand-logo demo">
                                    <?php echo $__env->make('_partials.logo', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                </span>
                            </a>
                        </div>
                        <!-- /Logo -->
                        <h4 class="mb-2">Welcome to <?php echo e(config('company_name') ?? config('variables.templateName')); ?>!
                        </h4>
                        <form id="login-form" class="mb-3" action="<?php echo e(route('user-login')); ?>" method="POST">
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" id="remember-me" name="rememberMe"
                                        value="1" <?php if(Session::get('rememberMe')): ?> checked <?php endif; ?>>
                                ...
                                <tr>
                                    ...
                                    <td class="text-truncate">
                                        <a class="btn btn-primary"
                                            href="<?php echo e(asset('assets/apk/rfidapp/galla-rfid-app.apk')); ?>">
                                            <span>Download</span>
                                        </a>
                                    </td>
                                </tr>
...
<?php echo $__env->make('layouts/blankLayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/gallamattressapp/resources/views/content/auth/auth-login.blade.php ENDPATH**/ ?>