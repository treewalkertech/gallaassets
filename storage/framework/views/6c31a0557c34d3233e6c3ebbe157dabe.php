<?php $__env->startSection('title', 'Device Registration - List'); ?>
        ...
        <div class="col-12">
            <div class="card p-3">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <a href="<?php echo e(route('device_registration.create')); ?>" class="btn btn-primary">
...
<?php $__env->startSection('page-script'); ?>
    ...
    <script>
        $(document).ready(function() {
            ...
            const options = {
                url: "<?php echo e(route('device_registration.list')); ?>",
                createUrl: "<?php echo e(route('device_registration.create')); ?>",
                displayLength: 20,
                is_delete: 0,
                delete_url: "<?php echo e(route('device_registration.delete')); ?>",
...
<?php echo $__env->make('layouts/contentNavbarLayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/gallamattressapp/resources/views/content/device_registration/list.blade.php ENDPATH**/ ?>