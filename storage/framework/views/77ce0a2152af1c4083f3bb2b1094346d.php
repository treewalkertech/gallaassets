<script type="text/javascript">
    $(document).ready(function() {
        ...
        let defaultDays =
            "<?php echo e(isset($default_days) ? $default_days : 30); ?>"; // Get default_days from Blade or use 30
        ...
        $('input[name="<?php echo e($name); ?>"]').daterangepicker({
            opens: "<?php echo e(isset($float) ? $float : 'right'); ?>",
            startDate: startDate,
...
<?php /**PATH /var/www/html/gallamattressapp/resources/views/content/common/scripts/daterangePicker.blade.php ENDPATH**/ ?>