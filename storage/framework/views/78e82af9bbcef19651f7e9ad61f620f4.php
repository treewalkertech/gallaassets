            ...
            <div class="table-responsive">
                <table>
                    ...
                    <tbody class="designation_table_body">
                        ...
                        ?>
                        <?php if(isset($designation) && $designation): ?>
                            <?php $__currentLoopData = $designation; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $values): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td class="text-nowrap">
                                        <input type="text" class="form-control" value="<?php echo e($values['name']); ?>"
                                            name="designation_details_fields[<?php echo e($key); ?>][name]">
                                    </td>
                                    <td class="text-nowrap">
                                        <input type="text" class="form-control bg-label-primary designation_keyname"
                                            value="<?php echo e($values['value']); ?>"
                                            name="designation_details_fields[<?php echo e($key); ?>][value]">
                                    </td>
                                    <td class="text-nowrap">
...
<?php /**PATH /var/www/html/gallamattressapp/resources/views/content/settings/tabs/designation.blade.php ENDPATH**/ ?>