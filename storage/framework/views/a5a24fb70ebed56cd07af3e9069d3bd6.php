...
<script>
    function EditPermissions() {
        ...
        window.location.href = "<?php echo e(route('roles.create')); ?>" + '/' + roleid;
    }
        ...
        form.addEventListener(
            ...
            function(event) {
                ...
                if (!form.checkValidity()) {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: "<?php echo e(route('roles.save')); ?>" + '/' +
...
<?php /**PATH /var/www/html/gallamattressapp/resources/views/content/modals/editRole.blade.php ENDPATH**/ ?>