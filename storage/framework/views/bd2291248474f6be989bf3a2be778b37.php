        ...
        <div class="col-12 col-sm-6 col-lg-4 col-xl-2">
            <div class="card h-100 metric-card">
                <div class="card-body">
                    ...
                    <h3 id="daily_bonding"><?php echo e($metrics['total_inventory'] ?? 0); ?></h3>
        ...
        <div class="col-12 col-sm-6 col-lg-4 col-xl-2">
            <div class="card h-100 metric-card">
                <div class="card-body">
                    ...
                    <h3 id="daily_tape_edge_qc"><?php echo e($metrics['total_products'] ?? 0); ?></h3>
        ...
        <div class="col-12 col-sm-6 col-lg-4 col-xl-2">
            <div class="card h-100 metric-card">
                <div class="card-body">
                    ...
                    <h3 id="daily_zip_cover_qc"><?php echo e($metrics['total_clean_products'] ?? 0); ?></h3>
        ...
        <div class="col-12 col-sm-6 col-lg-4 col-xl-2">
            <div class="card h-100 metric-card">
                <div class="card-body">
                    ...
                    <h3 id="daily_packaging"><?php echo e($metrics['total_dirty_products'] ?? 0); ?></h3>
        ...
        <div class="col-12 col-sm-6 col-lg-4 col-xl-2">
            <div class="card h-100 metric-card">
                <div class="card-body">
                    ...
                    <h3 id="total_packaging"><?php echo e($metrics['total_new_products'] ?? 0); ?></h3>
        ...
        <div class="col-12 col-sm-6 col-lg-4 col-xl-2">
            <div class="card h-100 metric-card">
                <div class="card-body">
                    ...
                    <h3 id="damaged_products"><?php echo e($metrics['total_damaged_products'] ?? 0); ?></h3>
...
<?php echo $__env->make('layouts/contentNavbarLayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/laundryApp/resources/views/content/dashboard/dashboards-analytics.blade.php ENDPATH**/ ?>