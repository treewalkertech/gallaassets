                    ...
                    <div class="row pt-3" id="filter-container">
                        <div class="col-md-3 mb-md-0 mb-3">
                            <select id="filterQcStatus" class="form-select filter-selected-data">
                                ...
                                <?php if(isset($stages) && $stages): ?>
                                    <?php $__currentLoopData = $status; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $statusArray): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($statusArray['value']); ?>"><?php echo e($statusArray['name']); ?></option>
                        ...
                        <div class="col-md-3 mb-md-0 mb-3">
                            <select id="filterCurrentStage" class="form-select filter-selected-data">
                                ...
                                <?php if(isset($stages) && $stages): ?>
                                    <?php $__currentLoopData = $stages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $arrays): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($arrays['value']); ?>"><?php echo e($arrays['name']); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                <?php endif; ?>
                            </select>
                        </div>
...
<?php $__env->startSection('page-script'); ?>
    ...
    <script>
        ...
        function commonGenerateReports(reportType) {
            ...
            $.ajax({
                url: "<?php echo e(route('reports.list')); ?>",
                method: "POST",
                data: {
        ...
        function downloadSeletedReport(reportType) {
            ...
            form.method = 'POST';
            form.action = "<?php echo e(route('reports.export')); ?>";
        ...
        function downloadDefectReport() {
            const form = document.createElement('form');
            form.method = 'POST';
            form.action = "<?php echo e(route('reports.defect_export')); ?>";
            form.style.display = 'none';
...
<?php echo $__env->make('layouts/contentNavbarLayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/gallamattressapp/resources/views/content/reports/list.blade.php ENDPATH**/ ?>