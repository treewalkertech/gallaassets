                        ...
                        <div class="row gy-4 gy-sm-1">
                            <div class="col-sm-6 col-lg-3">
                                <div
                                    ...
                                    <div>
                                        <h3 class="mb-1">
                                            <?php echo e(isset($usersOverview['total_users']) ? $usersOverview['total_users'] : '0'); ?>
                            ...
                            <div class="col-sm-6 col-lg-3">
                                <div
                                    ...
                                    <div>
                                        <h3 class="mb-1">
                                            <?php echo e(isset($usersOverview['total_active']) ? $usersOverview['total_active'] : '0'); ?>
                            ...
                            <div class="col-sm-6 col-lg-3">
                                <div
                                    ...
                                    <div>
                                        <h3 class="mb-1">
                                            <?php echo e(isset($usersOverview['total_pending']) ? $usersOverview['total_pending'] : '0'); ?>
...
<?php $__env->startSection('page-script'); ?>
    ...
    <?php echo $__env->make('content.modals.userView', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            var options1 = {
                ...
                createUrl: "<?php echo e(route('users.create')); ?>",
            ...
            $.ajax(url, {
                ...
                success: function(response) {
                    ...
                    if (response.data) {
                        ...
                        let url = "<?php echo e(url('users/activity')); ?>" + '/' + user.user_code;
...
<?php echo $__env->make('layouts/contentNavbarLayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/gallamattressapp/resources/views/content/users/list.blade.php ENDPATH**/ ?>