<form method="POST" action="<?php echo e(route('products.bulkProductUpload')); ?>" enctype="multipart/form-data" id="productsImport">
    <?php echo csrf_field(); ?>
...
<script>
    $(document).ready(function() {
        ...
        $("#import-format").click(function() {
            window.location.href = "<?php echo e(route('products.productImportFormat')); ?>";
        });
    });
</script>
<?php /**PATH /var/www/html/laundryApp/resources/views/content/products/modal/bulkProductImport.blade.php ENDPATH**/ ?>