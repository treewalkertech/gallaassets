            ...
            <div>
                <div class="mb-3">
                    ...
                    <input type="text" id="MAIL_MAILER" name="value[MAIL_MAILER]" class="form-control"
                        placeholder="Enter Mail Mailer" value="<?php echo e($UtilityHelper->getConfigValue("MAIL_MAILER")); ?>">
                </div>
                <div class="mb-3">
                    ...
                    <input type="text" id="MAIL_HOST" name="value[MAIL_HOST]" class="form-control"
                        placeholder="Enter Mail Host" value="<?php echo e($UtilityHelper->getConfigValue("MAIL_HOST")); ?>">
                </div>
                <div class="mb-3">
                    ...
                    <input type="text" id="MAIL_PORT" name="value[MAIL_PORT]" class="form-control"
                        placeholder="Enter Mail Port" value="<?php echo e($UtilityHelper->getConfigValue("MAIL_PORT")); ?>">
                </div>
                <div class="mb-3">
                    ...
                    <input type="text" id="MAIL_USERNAME" name="value[MAIL_USERNAME]" class="form-control"
                        placeholder="Enter Mail Username" value="<?php echo e($UtilityHelper->getConfigValue("MAIL_USERNAME")); ?>">
                </div>
                <div class="mb-3">
                    ...
                    <input type="text" id="MAIL_PASSWORD" name="value[MAIL_PASSWORD]" class="form-control"
                        placeholder="Enter Mail Password" value="<?php echo e($UtilityHelper->getConfigValue("MAIL_PASSWORD")); ?>">
                </div>
                <div class="mb-3">
                    ...
                    <input type="text" id="MAIL_ENCRYPTION" name="value[MAIL_ENCRYPTION]" class="form-control"
                        ...
                        value="<?php echo e($UtilityHelper->getConfigValue("MAIL_ENCRYPTION")); ?>">
                </div>
                <div class="mb-3">
                    ...
                    <input type="text" id="MAIL_FROM_ADDRESS" name="value[MAIL_FROM_ADDRESS]"
                        ...
                        value="<?php echo e($UtilityHelper->getConfigValue("MAIL_FROM_ADDRESS")); ?>">
                </div>
                <div class="mb-3">
                    ...
                    <input type="text" id="MAIL_FROM_NAME" name="value[MAIL_FROM_NAME]" class="form-control"
                        ...
                        value="<?php echo e($UtilityHelper->getConfigValue("MAIL_FROM_NAME")); ?>">
                </div>
            </div>
...
<?php /**PATH /var/www/html/gallamattressapp/resources/views/content/settings/tabs/email_config.blade.php ENDPATH**/ ?>